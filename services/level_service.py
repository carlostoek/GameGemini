...
# Umbrales de puntos para cada nivel (puedes ajustar según tu sistema)
LEVELS = [
...
def get_progress_to_next_level(points: int):
    """
    Devuelve dict con nivel actual, puntos, siguiente nivel, puntos restantes y % de progreso.
    """
